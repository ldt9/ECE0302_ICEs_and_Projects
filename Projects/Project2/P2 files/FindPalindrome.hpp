...
private:
	...
	// create a vector of type strings to hold each sentence
	std::vector <std::string> palinSent;

	//number of palindromes in existence
	int palinFreq;

	//size of the string vector
	std::size_t vectSize;

	//vector to hold a vector array of strings
	std::vector <std::vector <std::string>> palinVect;
